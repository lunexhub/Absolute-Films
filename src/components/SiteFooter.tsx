    ...
    <footer className="border-t border-border py-12 mt-12">
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
        ...
        <div className="flex flex-col gap-3 text-sm">
          ...
          <a href="mailto:info@absolutefilms.co.za" className="flex items-center gap-2 text-muted-foreground hover:text-gold transition-colors">
            <Mail className="w-4 h-4" /> info@absolutefilms.co.za
          </a>
